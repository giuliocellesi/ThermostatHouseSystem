...
HD_PWD='C:/Universit/SEA_2/Assignment_2/TopModule_Thermostat/TopModule_Thermostat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Thermostat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Thermostat.tcl
