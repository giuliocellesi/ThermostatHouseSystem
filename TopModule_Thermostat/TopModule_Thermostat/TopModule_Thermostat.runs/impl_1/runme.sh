...
HD_PWD='C:/Universit/SEA_2/Assignment_2/TopModule_Thermostat/TopModule_Thermostat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Thermostat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Thermostat.tcl -notrace
